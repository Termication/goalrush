...
export default function BundesligaTable() {
  ...
  return (
    ...
    >
      ...
      <button 
        onClick={scrollTable}
        className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-[#d20515] text-white p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-[#b00412]"
      >
