...
export default function PremierLeagueTable() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#38003c] text-white p-2 border-b border-gray-200 dark:border-gray-800">
      ...
      >
        <table className="w-full border-collapse text-xs">
          {/* Dark mode background for the sticky header */}
      ...
      <button 
        onClick={scrollTable}
        className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-[#38003c] text-white p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-[#500056] dark:hover:bg-[#6b0073]"
      >
